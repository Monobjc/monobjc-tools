...
namespace Monobjc.Tools.Generator.Parsers.Xhtml.Cocoa
{
    ...
    public class XhtmlCocoaClassParser : XhtmlCocoaTypeParser, IXhtmlClassParser
    {
        ...
        public XhtmlCocoaClassParser(NameValueCollection settings, TypeManager typeManager)
            : base(settings, typeManager)
        {
            this.MethodParser = new XhtmlCocoaMethodParser(settings, typeManager);
            this.PropertyParser = new XhtmlCocoaPropertyParser(settings, typeManager);
        }
        ...
        protected void ExtractProperties(ClassEntity classEntity, XElement root)
        {
            ...
            {
                PropertyEntity propertyEntity = this.PropertyParser.Parse(propertyElement);
