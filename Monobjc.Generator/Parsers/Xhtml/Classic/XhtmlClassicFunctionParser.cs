...
namespace Monobjc.Tools.Generator.Parsers.Xhtml.Classic
{
    ...
    /// </summary>
    public class XhtmlClassicFunctionParser : XhtmlBaseParser
    {
        /// <summary>
        ...
        public XhtmlClassicFunctionParser(NameValueCollection settings, TypeManager typeManager) : base(settings, typeManager) {}
        ...
        public FunctionEntity Parse(string name, IEnumerable<XElement> elements)
        {
