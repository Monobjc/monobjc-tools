...
namespace Monobjc.Tools.Generator.Parsers.Xhtml.Classic
{
    ...
    public class XhtmlClassicClassParser : XhtmlClassicTypeParser, IXhtmlClassParser
    {
        ...
        public XhtmlClassicClassParser(NameValueCollection settings, TypeManager typeManager)
            : base(settings, typeManager)
        {
            this.MethodParser = new XhtmlClassicMethodParser(settings, typeManager);
            this.PropertyParser = new XhtmlClassicPropertyParser(settings, typeManager);
        }
        ...
        protected void ExtractProperties(ClassEntity classEntity, XElement root)
        {
            ...
            if (list != null)
            {
                ...
                foreach (String name in names)
                {
                    ...
                    {
                        Console.WriteLine("MISSING marker for property " + name);
                    }
                }
            }
        }
        ...
        protected void ExtractMethods(ClassEntity classEntity, XElement root)
        {
            ...
            if (list != null)
            {
                ...
                foreach (String name in names)
                {
                    ...
                    {
                        Console.WriteLine("MISSING marker for method " + name);
                    }
                }
            }
        }
