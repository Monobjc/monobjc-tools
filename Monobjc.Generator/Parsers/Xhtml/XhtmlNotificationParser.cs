...
namespace Monobjc.Tools.Generator.Parsers.Xhtml
{
    ...
    /// </summary>
    public class XhtmlNotificationParser : XhtmlBaseParser
    {
        /// <summary>
        ...
        public XhtmlNotificationParser(NameValueCollection settings, TypeManager typeManager) : base(settings, typeManager) {}
        ...
        /// <returns></returns>
        public NotificationEntity Parse(XElement notificationElement)
        {
