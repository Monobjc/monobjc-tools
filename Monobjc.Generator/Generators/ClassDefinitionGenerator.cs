...
namespace Monobjc.Tools.Generator.Generators
{
    ...
    public class ClassDefinitionGenerator : ClassGenerator
    {
        ...
        public ClassDefinitionGenerator(StreamWriter writer, GenerationStatistics statistics) : base(writer, statistics) {}
        ...
        public override void Generate(BaseEntity entity)
        {
            ...
            this.Writer.WriteLineFormat(2, "public {0}(IntPtr value)", classEntity.Name);
            this.Writer.WriteLineFormat(3, ": base(value) {{}}");
            this.Writer.WriteLine();
