...
namespace Monobjc.Tools.Generator.Generators
{
    ...
    {
        /// <summary>
        ///   Initializes a new instance of the <see cref = "ClassDelegateGenerator" /> class.
        /// </summary>
        /// <param name = "writer">The writer.</param>
        /// <param name = "statistics">The statistics.</param>
        public ClassDelegateGenerator(StreamWriter writer, GenerationStatistics statistics) : base(writer, statistics) {}
