...
namespace Monobjc.Tools.Generator.Generators
{
    ...
    {
        /// <summary>
        ///   Initializes a new instance of the <see cref = "ClassConstantsGenerator" /> class.
        /// </summary>
        /// <param name = "writer">The writer.</param>
        /// <param name = "statistics">The statistics.</param>
        public ClassConstantsGenerator(StreamWriter writer, GenerationStatistics statistics) : base(writer, statistics) {}
